        ...
        <>
            <div className="flex flex-col gap-5 text-gray-300 ">
                ...
                <p className="text-[18px] pt-2 text-gray-300">
                    We are a team dedicated to iterate and improve <a className="underline" href="https://github.com/comfyanonymous/ComfyUI">ComfyUI</a>, support the ComfyUI ecosystem with tools like <a className="underline" target="_blank" rel="noreferrer" href="https://github.com/ltdrdata/ComfyUI-Manager">node manager</a>, <a className="underline" target="_blank" rel="noreferrer" href="https://www.comfyregistry.org">node registry</a>, <a className="underline" target="_blank" rel="noreferrer" href="https://github.com/Comfy-Org/comfy-cli">cli</a>, <a className="underline" target="_blank" rel="noreferrer" href="https://comfyci.org">automated testing</a>, and <a className="underline" href="https://docs.comfy.org" target="_blank" rel="noreferrer">public documentation</a>.
                </p>
